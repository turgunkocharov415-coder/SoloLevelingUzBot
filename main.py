...
from aiogram.types import ReplyKimport os
import asyncio
import psycopg2
import re
from aiogram import Bot, Dispatcher, types, F
...
async def show_season(message: types.Message):
    season = "".join(filter(str.isdigit, message.text))eyboardMarkup, KeyboardButton, InlineKeyboardMarkup, InlineKeyboardButton
